...
allparts = string_na_clean_list(otworz('io.csv'))
...
for i in range(0,len(zawory)):   
    ...
    o_HP = f'{zawory[i].rvalveNameHP(1)}\tBOOL\t{zawory[i].valveHP}{tmp}\t[{i+1}] {zawory[i].rvalveNameHP(1)}' #ez HP
    o_WP = f'{zawory[i].rvalveNameWP(1)}\tBOOL\t{zawory[i].valveWP}{tmp}\t[{i+1}] {zawory[i].rvalveNameWP(1)}' #ez WP
    ...
    pwrite(o_HP)
    tags.append([zawory[i].rvalveNameHP(1), zawory[i].valveHP, f'[{i+1}] {zawory[i].rvalveNameHP(1)}'])
    pwrite(o_WP)
    tags.append([zawory[i].rvalveNameWP(1), zawory[i].valveWP, f'[{i+1}] {zawory[i].rvalveNameWP(1)}'])
